...
<div class="page-title bg-custom  text-white py-4">
  <div class="container d-lg-flex justify-content-between align-items-center">
    <h3 class="mb-2 mb-lg-0"><?php echo htmlspecialchars($team_member['name']); ?> ( <?php echo htmlspecialchars($team_member['position']); ?> )</h3>
    ...
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6 col-xl-5">
        <?php if (!empty($team_member['avatar'])): ?>
                    <img class="service-img img-fluid" src="admin/<?php echo htmlspecialchars($team_member['avatar']); ?>" class="img-fluid rounded" loading="lazy" alt="<?php echo htmlspecialchars($team_member['name']); ?>" />
                <?php else: ?>
                    <img class="service-img img-fluid" class="img-fluid rounded" loading="lazy" src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHZpZXdCb3g9IjAgMCA0MCA0MCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc   3ZnIj4KPHJlY3Qgd2lkdGg9IjQwIiBoZWlnaHQ9IjQwIiBmaWxsPSIjRkZGRkZGIi8+Cjwvc3ZnPgo=" alt="Team Member Image" />
                <?php endif; ?>
      </div>
